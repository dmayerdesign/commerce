...
import { GetProductsFilterType, GetProductsFromIdsRequest, GetProductsRequest } from '@qb/common/api/requests/get-products.request'
import { ListFromQueryRequest, ListRequest } from '@qb/common/api/requests/list.request'
...
import { GetProductDetailResponseBody } from '@qb/common/api/responses/get-product-detail/get-product-detail.response.body'
